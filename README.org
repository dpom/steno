...
steno is a personal project to digitalize my stenographic writings.

** Description

In my youth most of my notes were written in shorthand (Duployer system). This project aims to digitalize old notes and integrate them into the current note system (org-roam).
...
:END:
*** DONE #25 Build a diff translator
SCHEDULED: <2025-07-09 Mi>
*** DONE #26 Add a build-references action in cli
*** DONE #28 Add logging enhancement
